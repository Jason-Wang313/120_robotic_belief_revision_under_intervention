...
Honest strongest claim: `Revise robot beliefs only when interventions reveal a violated physical assumption.` is a plausible branch-structured mechanism for interactive world models, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
