...
\usepackage{url}
\usepackage{booktabs}
\title{Robotic Belief Revision Under Intervention: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about interactive world models. The original research bet was: Revise robot beliefs only when interventions reveal a violated physical assumption. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item PI-VLA: A Symmetry-Aware Predictive and Interactive Vision--Language--Action Framework for Robust Robotic Manipulation (n.d.)
\item PI-VLA: Adaptive Symmetry-Aware Decision-Making for Long-Horizon Vision-Language-Action Manipulation (2026)
\item Generative World Explorer (2024)
\item Development of compositionality through interactive learning of language and action of robots (2025)
\item ACWM-Phys: Investigating Generalized Physical Interaction in Action-Conditioned Video World Models (2026)
\end{itemize}
